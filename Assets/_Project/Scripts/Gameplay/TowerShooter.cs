...
public class TowerShooter : MonoBehaviour
{
    ...
    public float fireRate = 1.2f;   // Sch�sse pro Sekunde
    ...
    private void Shoot(Transform t)
    {
        ...
        // Fallback: Wenn kein FirePoint gesetzt, nutze die Mitte des Objekts (leicht erhöht)
        ...
        {
            // Mitte des Objekts + Y-Offset für bessere Sichtbarkeit
